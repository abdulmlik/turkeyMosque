			...
			<div id="main-content">
				...
				<table>
					...
					if($Count > 0){
							...
							if($row['type']==1){
								echo"
									<tr class='$class'>
										...
										<td>{$row['date']}</td>
										<td>حجز نهائي</td>
										<td><a href='usershow.php?box=delete&id={$row['no']}'>إلغاء</a></td>
									</tr>
								";
							}else{
								echo"
						...
						echo'<tr class="e"><td colspan="4">لا توجد حجوزات</td></tr>';
					}
					?>
				</table>
					<!--<tr class="w">
			...
			<div id="main-sidebar">
				...
				<div class="sidebar-box">
					...
					<ul>
						...
						<li><a href="usershow.php" >حجوزاتي</a></li>
